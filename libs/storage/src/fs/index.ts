...
import { buildCreateDirIfNotExists } from "./helpers/createDirIfNotExists.js";
import { buildIsExistingPath } from "./helpers/isExistingPath.js";
import type {
...
>(params: CreateFSStorageParams<Schema, Result>): Storage {
	...
	const isExistingPath = buildIsExistingPath(logger);
	const createDirIfNotExists = buildCreateDirIfNotExists({
		logger,
		isExistingPath,
	});
